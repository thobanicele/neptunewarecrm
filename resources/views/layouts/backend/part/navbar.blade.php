                    ...
                    <a href="#" class="list-group-item">
                        <div class="row g-0 align-items-center">
                            ...
                            <div class="col-10">
                                ...
                                <div class="text-muted small mt-1">Aliquam ex eros, imperdiet vulputate hendrerit et.
                                </div>
            ...
            <div class="dropdown-menu dropdown-menu-lg dropdown-menu-end py-0" aria-labelledby="messagesDropdown">
                ...
                <div class="list-group">
                    ...
                    <a href="#" class="list-group-item">
                        <div class="row g-0 align-items-center">
                            <div class="col-2">
                                <img src="{{ asset('asset/img/avatars/avatar-2.jpg') }}"
                    ...
                    <a href="#" class="list-group-item">
                        <div class="row g-0 align-items-center">
                            <div class="col-2">
                                <img src="{{ asset('asset/img/avatars/avatar-4.jpg') }}"
                    ...
                    <a href="#" class="list-group-item">
                        <div class="row g-0 align-items-center">
                            <div class="col-2">
                                <img src="{{ asset('asset/img/avatars/avatar-3.jpg') }}"
