            ...
            <div class="card-body pb-0">
                ...
                <div class="d-flex justify-content-between align-items-center mb-2">
                    <div class="text-muted small">
                        Showing <b>{{ $creditNotes->firstItem() ?? 0 }}</b>–<b>{{ $creditNotes->lastItem() ?? 0 }}</b>
                        of <b>{{ $creditNotes->total() }}</b> credit notes
                    </div>

                    @if (($q ?? '') !== '' || ($company_id ?? '') !== '' || ($state ?? '') !== '')
                        <a class="small text-decoration-none" href="{{ tenant_route('tenant.credit-notes.index') }}">
                            Clear filters
                        </a>
                    @endif
                </div>
                ...
                <table class="table table-hover table-sm align-middle mb-0">
                    ...
                    <tbody>
                        @forelse($creditNotes as $cn)
                            ...
                            <tr>
                                <td class="text-muted">
                                    {{ optional($cn->issued_at)->format('d/m/Y') ?? '—' }}
                                </td>

                                <td class="fw-semibold">
                                    <a href="{{ tenant_route('tenant.credit-notes.show', $cn) }}">
                                ...
                                {{-- ✅ use computed totals to avoid N+1 --}}
                                ...
                                <td class="text-end">
                                    <div class="btn-group">
                                        ...
                                        <ul class="dropdown-menu dropdown-menu-end">
                                            <li>
                                                {{-- keep your route name if this is how you defined it --}}
