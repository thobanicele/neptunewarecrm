    ...
    <div class="container-fluid p-0">
        ...
        <div class="d-flex justify-content-between align-items-center mb-3 flex-wrap gap-2">
            <div>
                ...
                <h1 class="h3 mb-0">Add Payment Term</h1>
                <div class="text-muted small">Create a new payment term for your customers.</div>
            </div>
        ...
        <div class="card">
            <div class="card-body">
                <form method="POST" action="{{ tenant_route('tenant.settings.payment_terms.store') }}">
                    @csrf

                    @include('tenant.settings.payment_terms._form')
