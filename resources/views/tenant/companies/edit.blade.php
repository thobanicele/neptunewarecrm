                    ...
                    <div class="row g-3">
                        ...
                        <div class="col-12 col-md-6">
                            ...
                            <select class="form-select" name="type">
                                @foreach (['prospect', 'customer', 'individual'] as $t)
                                    <option value="{{ $t }}" @selected(old('type', $company->type) === $t)>{{ $t }}</option>
                                @endforeach
                            </select>
                        </div>
                        ...
                        <div class="col-12 col-md-6">
                            ...
                            <input type="text" class="form-control" name="payment_terms"
                                ...
                                placeholder="e.g. COD / 30 Days / 50% Deposit">
                        </div>
                            ...
                            <div class="border rounded p-3">
                                <div class="d-flex justify-content-between align-items-center mb-2">
                                    ...
                                    <div class="form-check">
                                        <input class="form-check-input" type="checkbox" name="billing[is_default_billing]" value="1"
                                            @checked(old('billing.is_default_billing', data_get($billing, 'is_default_billing', true))) id="billDefault">
                                ...
                                <div class="mb-2">
                                    ...
                                    <input class="form-control" name="billing[label]"
                                        value="{{ old('billing.label', data_get($billing,'label','Head Office')) }}">
                                </div>
                                ...
                                <div class="mb-2">
                                    ...
                                    <input class="form-control" name="billing[line1]"
                                        value="{{ old('billing.line1', data_get($billing,'line1')) }}">
                                </div>

                                <div class="mb-2">
                                    <label class="form-label">Address Line 2</label>
                                    <input class="form-control" name="billing[line2]"
                                        value="{{ old('billing.line2', data_get($billing,'line2')) }}">
                                </div>
                                ...
                                <div class="row g-2">
                                    <div class="col-md-6 mb-2">
                                        ...
                                        <select class="form-select js-country" name="billing[country_iso2]" data-target="billing">
                                            <option value="">— select —</option>
                                            @foreach ($countries ?? collect() as $c)
                                                <option value="{{ $c->iso2 }}"
                                                    @selected(old('billing.country_iso2', data_get($billing,'country_iso2','ZA')) === $c->iso2)>
                                                    {{ $c->name }}
                                                </option>
                                            @endforeach
                                        </select>
                                    ...
                                    <div class="col-md-6 mb-2">
                                        ...
                                        <select class="form-select js-subdivision" name="billing[subdivision_id]" data-target="billing">
                                            <option value="">— select —</option>
                                        </select>
                        ...
                        <div class="col-12 col-lg-6">
                            <div class="border rounded p-3">
                                <div class="d-flex justify-content-between align-items-center mb-2">
                                    ...
                                    <div class="form-check">
                                        <input class="form-check-input" type="checkbox" name="shipping[is_default_shipping]" value="1"
                                            @checked(old('shipping.is_default_shipping', data_get($shipping, 'is_default_shipping', true))) id="shipDefault">
                                ...
                                <div class="mb-2">
                                    ...
                                    <input class="form-control" name="shipping[label]"
                                        value="{{ old('shipping.label', data_get($shipping,'label','Delivery')) }}">
                                </div>
                                ...
                                <div class="mb-2">
                                    ...
                                    <input class="form-control" name="shipping[line1]"
                                        value="{{ old('shipping.line1', data_get($shipping,'line1')) }}">
                                </div>

                                <div class="mb-2">
                                    <label class="form-label">Address Line 2</label>
                                    <input class="form-control" name="shipping[line2]"
                                        value="{{ old('shipping.line2', data_get($shipping,'line2')) }}">
                                </div>
                                ...
                                <div class="row g-2">
                                    <div class="col-md-6 mb-2">
                                        <label class="form-label">Country</label>
                                        <select class="form-select js-country" name="shipping[country_iso2]" data-target="shipping">
                                            <option value="">— select —</option>
                                            @foreach ($countries ?? collect() as $c)
                                                <option value="{{ $c->iso2 }}"
                                                    @selected(old('shipping.country_iso2', data_get($shipping,'country_iso2','ZA')) === $c->iso2)>
                                                    {{ $c->name }}
                                                </option>
                                            @endforeach
                                        </select>
                                    ...
                                    <div class="col-md-6 mb-2">
                                        <label class="form-label">Province/State</label>
                                        <select class="form-select js-subdivision" name="shipping[subdivision_id]" data-target="shipping">
                                            <option value="">— select —</option>
                                        </select>
                                ...
                                <div class="form-text mt-2">
                                    Tip: If shipping = billing, you can keep them the same or update later.
                                </div>
                            </div>
                        </div>
                    </div>
...
(function() {
    ...
    function fillSubdivisions(target, list, selectedId, selectedText) {
        ...
        if (!list.length) {
            ...
            if (selectedText) txt.value = selectedText;
            return;
        }
        ...
        // If there is no selectedId but user has text, show text input instead
    ...
    async function bootOne(target, iso2, selectedSubdivisionId, selectedSubdivisionText) {
        const list = await loadSubdivisions(iso2);
        fillSubdivisions(target, list, selectedSubdivisionId, selectedSubdivisionText);
    }
    ...
    bootOne(
        ...
        @json(old('billing.subdivision_text', data_get($billing,'subdivision_text')))
    );
    ...
    bootOne(
        ...
        @json(old('shipping.subdivision_text', data_get($shipping,'subdivision_text')))
    );
})();
</script>
@endpush
