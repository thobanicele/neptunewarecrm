                                ...
                                <div class="row g-2">
                                    ...
                                    <div class="col-6">
                                        ...
                                        <select class="form-select @error('sales_person_user_id') is-invalid @enderror"
                                            ...
                                            @foreach ($salesPeople ?? collect() as $u)
                                                <option value="{{ data_get($u, 'id') }}" @selected((string) old('sales_person_user_id', $quote->sales_person_user_id) === (string) data_get($u, 'id'))>
                                                    {{ data_get($u, 'name') }}
                                                </option>
                                            @endforeach
                                        </select>
                                    ...
                                    <div class="col-12">
                                        ...
                                        <select class="form-select" name="deal_id" id="dealSelect">
                                            ...
                                            @foreach ($deals ?? collect() as $d)
                                                <option value="{{ data_get($d, 'id') }}" @selected((string) old('deal_id', $quote->deal_id) === (string) data_get($d, 'id'))>
                                    ...
                                    <div class="col-12">
                                        ...
                                        <input type="text" class="form-control" name="customer_reference"
                                            value="{{ old('customer_reference', $quote->customer_reference) }}"
                        ...
                        <div class="col-12 col-lg-8">
                            ...
                            <select class="form-select" name="company_id" id="companySelect" required>
                                ...
                                @foreach ($companies ?? collect() as $c)
                                    <option value="{{ data_get($c, 'id') }}" @selected((string) old('company_id', $quote->company_id) === (string) data_get($c, 'id'))>
                                        {{ data_get($c, 'name') }}
                                    </option>
                                @endforeach
                            </select>
                        ...
                        <div class="col-12 col-lg-4">
                            ...
                            <select class="form-select" name="contact_id" id="contactSelect">
                                ...
                                @foreach ($contacts ?? collect() as $p)
                                    <option value="{{ data_get($p, 'id') }}" @selected((string) old('contact_id', $quote->contact_id) === (string) data_get($p, 'id'))>
                                        {{ data_get($p, 'name') }}
                                    </option>
                                @endforeach
                            </select>
