...
@section('content')
    <div class="container-fluid py-4">
        ...
        <form method="POST" action="{{ tenant_route('payments.store') }}">
            @csrf
                ...
                <div class="card-body">
                    ...
                    <div class="row g-3">
                        <div class="col-12 col-lg-7">
                            ...
                            @enderror
                            <div class="form-text">Payment will auto-allocate to oldest outstanding invoices unless you
                                select one below.</div>
                        </div>
                        ...
                        <div class="col-12 col-lg-4">
                            ...
                            <input type="date" class="form-control @error('received_at') is-invalid @enderror"
                                name="received_at" value="{{ old('received_at', now()->toDateString()) }}" required>
                            @error('received_at')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                        ...
                        <div class="col-12 col-lg-6">
                            ...
                            <div class="form-text">If selected, we’ll allocate to this invoice first (then remainder to
                                others).</div>
                        </div>
