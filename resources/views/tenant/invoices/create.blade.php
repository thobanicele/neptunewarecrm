...
@section('content')
    ...
    {{-- Reusable quick add product modal --}}
...
@push('scripts')
    {{-- Reusable quick add product scripts --}}
                ...
                function buildSuggestActionsHtml() {
                    ...
                    return `
                        <div class="nw-opt nw-opt-action" data-action="create-product">
                            ...
                            <div class="nw-sub">
                                <span>Add without leaving this invoice</span>
